var ZKClientWrapper = require('./ZKClientWrapper'),
    async = require('async'),
    _ = require('lodash'),
    debug = require('debug')('Monitoring:KafkaMonitor'),
...
var KafkaMonitor = function(zookeepers){
    self = this;
    events.EventEmitter.call(this);  

    debug('Connecting to zookeeper(s) : ' + zookeepers);

    zkClientWrapper.connectToZk(zookeepers);
}
