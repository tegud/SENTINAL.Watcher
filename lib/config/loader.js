...
module.exports = {
	loadConfigurationForModules: function(rootDir, modules, callback) {
		var tasks = _.map(modules, function(module) {
			return async.apply(getConfiguredModules, rootDir + '/' + module);
		});
